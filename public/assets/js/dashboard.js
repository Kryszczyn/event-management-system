...
function sidebarColor(a) {
  ...
  parent.classList.add('sidenav-bg-gradient-primary');
}
...
$(document).ready(function(){
    ...
    $(links).removeClass('sidenav-bg-gradient-primary');
    let url = window.location.pathname;
    let fileName = url.substring(url.lastIndexOf('/')+1);
    fileName = fileName.split('.')[0]
    $(links).each(function(){
      if($(this).data('link') == fileName){
        $(this).addClass('sidenav-bg-gradient-primary')
      }
    })
})